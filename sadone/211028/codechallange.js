// Challenge no.1 will be soved after ARRAY study.
...
// A만원의 고정 비용이 들며, 한 대의 노트북을 생산하는 데에는 재료비와 인건비 등
...
function bep(a, b, c) {
    ...
    if (b >= c) {
        ...
        console.log('a,b,c should be under 210000');
    }
}
